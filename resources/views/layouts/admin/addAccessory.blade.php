<form class="mt-5" method="post" enctype="multipart/form-data" action="/adminpanel/add-accessory/submit">
    @csrf
    <div class="mb-3 row">
    ...
    <div class="mb-3 row">
        <button type="submit" class="btn btn-outline-dark">Добавить аксессуар</button>
    </div>
</form>
